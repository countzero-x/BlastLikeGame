...
export class GameConfig {
    ...
    static readonly SUPERTILE_RADIUS_BOMB = 2;

    static readonly BOOSTER_BOMB_COUNT = 3;
    static readonly BOOSTER_TELEPORT_COUNT = 3;
    static readonly BOOSTER_RADIUS_BOMB = 2;
}
